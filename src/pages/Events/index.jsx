                    ...
                    <div className={`${style.events}`}>
                        <div className="py-5 position-relative" style={{zIndex: 2}}>
                            <div className="border-bottom border-3 border-light w-75 mx-auto mb-4">
                                <p className="my-3 garlicha text-warning fw-semibold" style={{fontSize: '3rem'}}>Akad Nikah</p>
                            </div>
                        ...
                        <div className="py-5 position-relative" style={{zIndex: 2}}>
                            <div className="border-bottom border-3 border-light w-75 mx-auto mb-4">
                                <p className="my-3 garlicha text-warning fw-semibold" style={{fontSize: '3rem'}}>Resepsi</p>
                            </div>
