      ...
      />
        <div className={`${style.cover} d-flex flex-column justify-content-center align-items-center h-100`}>
          <div style={{ zIndex: 2 }}>
            ...
            <p className="garlicha fw-bold text-warning2 animate__animated animate__slideInRight animate__slower mb-4 mt-4" style={{  fontSize: '3.2rem', letterSpacing: '0.2rem' }}>
              Sisin
            </p>
            ...
            <p className="garlicha fw-bold text-warning2 animate__animated animate__slideInLeft animate__slower mb-4" style={{  fontSize: '3.2rem', letterSpacing: '0.2rem' }}>
              Ikhtiar
            </p>
          </div>
          ...
          <div className={`px-5 pb-3 rounded-3 andada`} style={{ fontSize: '0.72rem', zIndex: 2 }}>
            <div className="">
              ...
              <p className="my-1 text-warning2 animate__animated animate__zoomIn animate__delay-2s animate__slower fs-5 pt-2">{name}</p>
            </div>
          </div>
